...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fbe42e2e-f4a8-42ac-be00-511cd2747211
```

> `fbe42e2e-f4a8-42ac-be00-511cd2747211` is the password of the certificate, you can change it to any password you want.
